	...
	<section class="MVIEW row justify-content-center paddingBotom">
				<div class="col-lg-10">
					<div class="row justify-content-center ">
						<h1 class="text-center mt-5 mb-5">Liste des articles de prévention</h1>
					</div>
					...
					<div class="row justify-content-center">
						<div class="col-12 p-0">
							<div class="input-group input-group-sm">
								<input type="search" placeholder="Recherche par article" id="searchPreventions" class="border border-secondary mt-3" aria-label="Search" />
							</div>
						</div>
					</div>
					<div class="row justify-content-left">
						<div class="col-1 mt-3 p-0 ml-0" id="newPreventionDivS">
							<button id="newPreventions" name="newPreventions" class="btn btn-secondary">+</button>
						</div>
					</div>
					<?php
							$pageActuelle = (isset($_GET["page"]))?intval($_GET["page"]):1;
							echo '<div class="row justify-content-md-center" id="tableaupreventionsAdmin">';
							?>
					<!-- debut tableau-->
