	<?php
		...
		if(isset($_SESSION["emailutilisateur"])) {
			...
			if($session->selectGradeOf($_SESSION["emailutilisateur"]) == "admin") {
				$admin = true;
				$adminEmail = $_SESSION["emailutilisateur"];
			} 
	...
	<section class="MVIEW row justify-content-center paddingBotom">
				<div class="col-lg-10">
					<div class="row justify-content-center ">
						<h1 class="text-center mt-5 mb-5">Liste des Utilisateurs</h1>
					</div>
					...
					<div class="row justify-content-center">
						<div class="col-12 p-0">
							<div class="input-group input-group-sm">
								<input type="search" placeholder="Recherche par Nom/Prenom" id="searchUsers" class="border border-secondary mt-3" aria-label="Search" />
							</div>
						</div>
					</div>
					...
					<?php
							...
							echo '<div class="row justify-content-md-center" id="tableauUsersAdmin">';
							?>
					<!-- debut tableau-->
